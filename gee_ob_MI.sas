...
TITLE " multiple imputation - maternal modifiable factors - no moob";
...
TITLE " multiple imputation - moob";
ods output ParameterEstimates=mi_mob;
PROC MIANALYZE parms=mob;
MODELEFFECTS INTERCEPT mowestq1 mowestq2 mowestq3 mocalq1 mocalq2 mocalq3 
	    mopaq0 mopaq1 mopaq2 mosmk2 mosmk3 moob
		moshiftq1 moshiftq2 moshiftq3 
  		moage cohort chage white sex  ;
RUN;
...
MODELEFFECTS INTERCEPT mowestq1 mowestq2 mowestq3 mocalq1 mocalq2 mocalq3 
	    mopaq0 mopaq1 mopaq2 mosmk2 mosmk3 moshiftq1 moshiftq2 moshiftq3 moob
		abwt1 abwt3 gweek1 gweek3 Delivery pregcomp2 bpregob 
  		prev_preg1 prev_preg2 prev_preg3 moage cohort chage white sex  ;
RUN;
...
proc export data=allob
     outfile='/udd/nhywa/GUTSOB/gee_ob_MI.csv'
     dbms=csv
     replace;
run;
