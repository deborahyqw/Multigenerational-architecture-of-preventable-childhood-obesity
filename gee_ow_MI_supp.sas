/*******************************************************************************
Program name: gee_ow_MI_supp.sas
...
proc export data=allow
     outfile='/udd/nhywa/GUTSOB/gee_ow_MI_supp.csv'
     dbms=csv
     replace;
run;
...
proc freq data=all; 
	...
	table (foodswampq superq restq fastq convq
			...
			foodswampaq superaq restaq fastaq convaq )*chow; 
run; 
...
proc genmod data = all descending;
 by _imputation_ ;
 class id momid;
   model chow = &foodswampq_ &sesq_ heduc1 heduc2 fincome1 fincome2 fincome3 
...
proc genmod data = all descending;
 by _imputation_ ;
 class id momid;
   model chow = foodswamp_m ses_m husbeduc income 
   				midwest south west cohort chage white sex 
     / dist = Poisson link = log;
     repeated subject=id(momid)/type=unstr PRINTMLE ecovb;
...
proc genmod data = all descending;
 by _imputation_ ;
 class id momid;
   model chow = &superq_ &restq_ &fastq_ &convq_ &sesq_ heduc1 heduc2 fincome1 fincome2 fincome3 
   				midwest south west cohort chage white sex 
     / dist = Poisson link = log;
     repeated subject=id(momid)/type=unstr PRINTMLE ecovb;
...
proc genmod data = all descending;
 by _imputation_ ;
 class id momid;
   model chow = super_m rest_m fast_m conv_m ses_m husbeduc income
   				midwest south west cohort chage white sex 
     / dist = Poisson link = log;
     repeated subject=id(momid)/type=unstr PRINTMLE ecovb;
...
proc genmod data = all descending;
 by _imputation_ ;
 class id momid;
   model chow = &foodswampzq_ &sesq_ heduc1 heduc2 fincome1 fincome2 fincome3 
   				midwest south west cohort chage white sex 
     / dist = Poisson link = log;
     repeated subject=id(momid)/type=unstr PRINTMLE ecovb;
...
proc genmod data = all descending;
 by _imputation_ ;
 class id momid;
   model chow = foodswampz_m ses_m husbeduc income 
   				midwest south west cohort chage white sex 
     / dist = Poisson link = log;
     repeated subject=id(momid)/type=unstr PRINTMLE ecovb;
...
proc genmod data = all descending;
 by _imputation_ ;
 class id momid;
   model chow = &superzq_ &restzq_ &fastzq_ &convzq_ &sesq_ heduc1 heduc2 fincome1 fincome2 fincome3 
   				midwest south west cohort chage white sex 
     / dist = Poisson link = log;
     repeated subject=id(momid)/type=unstr PRINTMLE ecovb;
...
proc genmod data = all descending;
 by _imputation_ ;
 class id momid;
   model chow = superz_m restz_m fastz_m convz_m ses_m husbeduc income
   				midwest south west cohort chage white sex 
     / dist = Poisson link = log;
     repeated subject=id(momid)/type=unstr PRINTMLE ecovb;
...
proc genmod data = all descending;
 by _imputation_ ;
 class id momid;
   model chow = &foodswampaq_ &sesq_ heduc1 heduc2 fincome1 fincome2 fincome3 
   				midwest south west cohort chage white sex 
     / dist = Poisson link = log;
     repeated subject=id(momid)/type=unstr PRINTMLE ecovb;
...
proc genmod data = all descending;
 by _imputation_ ;
 class id momid;
   model chow = foodswampa_m ses_m husbeduc income 
   				midwest south west cohort chage white sex 
     / dist = Poisson link = log;
     repeated subject=id(momid)/type=unstr PRINTMLE ecovb;
...
proc genmod data = all descending;
 by _imputation_ ;
 class id momid;
   model chow = &superaq_ &restaq_ &fastaq_ &convaq_ &sesq_ heduc1 heduc2 fincome1 fincome2 fincome3 
   				midwest south west cohort chage white sex 
     / dist = Poisson link = log;
     repeated subject=id(momid)/type=unstr PRINTMLE ecovb;
...
proc genmod data = all descending;
 by _imputation_ ;
 class id momid;
   model chow = supera_m resta_m fasta_m conva_m ses_m husbeduc income
   				midwest south west cohort chage white sex 
     / dist = Poisson link = log;
     repeated subject=id(momid)/type=unstr PRINTMLE ecovb;
...
title ' PHYSICIAN RATIO '; 
 ...
 by _imputation_ ;
 class id momid;
   model chow = &physicianq_ &sesq_ heduc1 heduc2 fincome1 fincome2 fincome3 
 ...
 by _imputation_ ;
 class id momid;
   model chow = physician_m ses_m husbeduc income
   				midwest south west chage white sex 
     / dist = Poisson link = log;
     repeated subject=id(momid)/type=unstr PRINTMLE ecovb;
...
title ' FOOD DESERT ';  
 ...
 by _imputation_ ;
 class id momid;
   model chow = &desertq_ &sesq_ heduc1 heduc2 fincome1 fincome2 fincome3 
   				midwest south west chage white sex
     / dist = Poisson link = log;
     repeated subject=id(momid)/type=unstr PRINTMLE ecovb;
 ...
 by _imputation_ ;
 class id momid;
   model chow = desert_m ses_m husbeduc income
   				 midwest south west chage white sex 
     / dist = Poisson link = log;
     repeated subject=id(momid)/type=unstr PRINTMLE ecovb;
