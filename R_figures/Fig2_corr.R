...
cor_mat <- read.csv("Fig2_corr_exposure_figure.csv", row.names = 1, header = TRUE, check.names = FALSE) |> as.matrix()
...
group_df <- tribble(
  ...
  "Paternal education",             "Socioeconomic",
  "Household income",               "Socioeconomic",
  "Neighborhood SES index",         "Socioeconomic",
