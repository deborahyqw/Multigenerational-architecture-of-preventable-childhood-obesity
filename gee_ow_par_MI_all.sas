/*******************************************************************************
Program name: gee_ow_par_MI_all.sas
Purpose: Calculate PAR for all exposures for overweight risk with multiple imputation
...
proc genmod data = all descending;
	by _imputation_ ;
 class id momid ;
   model chow = &mowestq_ &mocalq_ &mopaq_ mosmk2 mosmk3 moow &moshiftq_ 
...
*ever had negative coef:
	mowestq1 mowestq2 mowestq3 mopaq0 mopaq1 mopaq2 moshiftq3 abwt1
	gweek1 gweek3 sesq0 fincome2 fincome3 chpaq1 chpaq2
	;
...
data betas; 
  ...
  _type_ = 'PARM';
	retain intercept mowestq1 mowestq2 mowestq3 mocalq1 mocalq2 mocalq3 
		mopaq0 mopaq1 mopaq2 mosmk2 mosmk3 moow moshiftq1 moshiftq2 moshiftq3 
		abwt1 abwt3 gweek1 gweek3 Delivery pregcomp2 bpregow 
	...
	* 'i' counts rows within each _imputation_ group ;
	...
	when (13) moow     = estimate;    when (14) moshiftq1= estimate;    when (15) moshiftq2= estimate;    
    ...
    when (22) pregcomp2  = estimate;  when (23) bpregow   = estimate;   when (24) sesq0     = estimate;   
  ...
  * set negative beta to 0 to 1) avoid errors in PAR and 2) to prevent certain exposures were omitted from PAR calculation;
  ...
  if moshiftq3 <0 then moshiftq3=0;    if abwt1 <0 then abwt1 =0;     
  if gweek1 <0 then  gweek1=0;         if gweek3 <0 then gweek3 =0;
  if sesq0 <0 then sesq0 =0;           if fincome2 <0 then fincome2 =0;     
  if fincome3 <0 then fincome3 =0;     if chpaq1 <0 then chpaq1 =0; 
...
data covparms;  
	...
	rename  Prm1=intercept   Prm2=mowestq1    Prm3=mowestq2    Prm4=mowestq3    Prm5=mocalq1  
			...
			Prm11=mosmk2     Prm12=mosmk3     Prm13=moow
			...
			Prm23=bpregow    Prm24=sesq0      Prm25=sesq1      Prm26=sesq2      Prm27=heduc1     
	...
	* Assign which row this is (the row "label" in the covariance matrix) ;
	select(i);
        ...
        when(23)  _name_ = 'bpregow';    when(24)  _name_ = 'sesq0';     when(25)  _name_ = 'sesq1';
...
%par(
	...
	n_or_p=N,
	n_or_pname=FQ,
	modvar= mowestq1 mowestq2 mowestq3 mopaq0 mopaq1 mopaq2 mosmk2 moow moshiftq1 moshiftq2
		abwt1 abwt3 gweek3 Delivery pregcomp2 bpregow sesq0 sesq1 sesq2 heduc1 heduc2 fincome1 fincome2
...
%runPAR(prefixBeta=betacov, prefixFreq=freqs, outpref=comp,
        modmod = mowestq1 mowestq2 mowestq3 mopaq0 mopaq1 mopaq2 mosmk2 mosmk3 moow moshiftq1 moshiftq2 moshiftq3
		abwt1 abwt3 gweek1 gweek3 Delivery pregcomp2 bpregow sesq0 sesq1 sesq2 heduc1 heduc2 fincome1 fincome2 fincome3
...
%runPAR(prefixBeta=betacov, prefixFreq=freqs, outpref=mom,
        modmod = mowestq1 mowestq2 mowestq3 mopaq0 mopaq1 mopaq2 mosmk2 mosmk3 moow moshiftq1 moshiftq2 moshiftq3,
        fixfix = abwt1 abwt3 gweek1 gweek3 Delivery pregcomp2 bpregow 
				sesq0 sesq1 sesq2 heduc1 heduc2 fincome1 fincome2 fincome3
				chwestq1 chwestq2 chwestq3 chstq1 chstq2 chstq3 chpaq0 chpaq1 chpaq2
...
%runPAR(prefixBeta=betacov, prefixFreq=freqs, outpref=uter,
        ...
        fixfix = mowestq1 mowestq2 mowestq3 mopaq0 mopaq1 mopaq2 mosmk2 mosmk3 moow moshiftq1 moshiftq2 moshiftq3
        		sesq0 sesq1 sesq2 heduc1 heduc2 fincome1 fincome2 fincome3
				chwestq1 chwestq2 chwestq3 chstq1 chstq2 chstq3 chpaq0 chpaq1 chpaq2
				mocalq1 mocalq2 mocalq3  
		        chcalq1 chcalq2 chcalq3 
