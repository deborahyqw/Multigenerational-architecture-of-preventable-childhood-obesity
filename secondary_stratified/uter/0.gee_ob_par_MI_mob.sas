...
%LET covar1= cohort chage white sex ; run; /*MANUAL SPECIFICATION OF VARIABLES*/
	...
	* Only OUTPUT once per _imputation_, after we've assigned all param columns ;
	...
	data covparms;  
		...
		* Output EVERY row;
		...
		keep _imputation_ _type_ _name_ prm1-prm10 ; /*MANUAL SPECIFICATION OF PARAMETER RANGE*/
	run;
