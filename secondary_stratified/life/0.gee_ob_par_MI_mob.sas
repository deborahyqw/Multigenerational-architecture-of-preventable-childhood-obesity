...
stratified maternal obesity status
...
%LET covar1= chbmibase cohort chage white sex; run; /*MANUAL SPECIFICATION OF VARIABLES*/
...
%macro ob_par_MI_strat (data=, group=);
	...
	**********************************************************************/
	...
	keep _imputation_ _type_ _name_ prm1-prm18 ; /*MANUAL SPECIFICATION OF PARAMETER RANGE*/
	run;
